...
//     theme: 'bg-gradient-to-br from-purple-900 via-black to-gray-900',
...
//     theme: 'bg-gradient-to-br from-blue-900 via-black to-gray-900',
...
//     theme: 'bg-gradient-to-br from-orange-900 via-black to-gray-900',
...
//     theme: 'bg-gradient-to-br from-emerald-900 via-black to-gray-900',
...
//     theme: 'bg-gradient-to-br from-red-900 via-black to-gray-900',
...
//     theme: 'bg-gradient-to-br from-indigo-900 via-black to-gray-900',
...
//     theme: 'bg-gradient-to-br from-amber-900 via-black to-gray-900',
...
//   const [currentTheme, setCurrentTheme] = useState('bg-gradient-to-br from-purple-900 via-black to-gray-900');
...
//       setCurrentTheme(moods[mood].theme);
//     } catch (err) {
...
//         break;
//       case 'Play Music':
//         window.open(`https://open.spotify.com/playlist/${moods[selectedMood].playlistId}`);
//         break;
//       case 'Get Advice':
...
//     <>
//       <Navbar/>
//       <div className={`min-h-screen ${currentTheme} text-white p-4 md:p-20 transition-colors duration-500`}>
//         {/* Header */}
//         <div className="text-center mb-10">
//           <h1 className="text-4xl font-extrabold tracking-wide bg-clip-text text-transparent bg-gradient-to-r from-fuchsia-400 via-pink-400 to-red-400">

//           </h1>
//           <p className=" text-xl font-bold text-gray-400 italic ">
//             Welcome,  How are you feeling today?✨ <span className="text-white font-semibold">{user?.email}</span>
//           </p>
//         </div>
...
//               className={`rounded-2xl p-4 md:p-6 shadow-xl text-black font-semibold text-lg backdrop-blur-xl transition-all duration-300
//                 ${moods[mood].color} ${moods[mood].hoverColor}`}
//             >
//               <div className="flex flex-col items-center justify-center space-y-2">
//                 <span className="text-3xl md:text-4xl">{moods[mood].emoji}</span>
//                 <span className="capitalize text-sm md:text-base">{mood}</span>
//               </div>
//             </motion.button>
//           ))}
//         </div>
...
//             className="mx-auto max-w-xl bg-white/5 border border-white/10 backdrop-blur-lg p-6 md:p-8 rounded-3xl shadow-lg mb-12"
//           >
//             <h2 className="text-2xl font-bold mb-4 text-pink-500">
//               {moods[selectedMood].emoji} {selectedMood.charAt(0).toUpperCase() + selectedMood.slice(1)}
//             </h2>
//             <p className="mb-6 text-gray-200">{moods[selectedMood].description}</p>
...
//                 initial={{ scale: 0.9 }}
//                 animate={{ scale: 1 }}
//                 className="bg-gradient-to-br from-gray-800 to-gray-900 border border-pink-500/30 rounded-2xl p-6 w-full max-w-md shadow-xl"
//               >
...
//                   className="w-full bg-gray-700/50 border border-gray-600 rounded-lg p-4 text-white mb-4 focus:ring-2 focus:ring-pink-500 focus:border-transparent"
...
//                     className={`px-4 py-2 rounded-lg bg-gradient-to-r from-pink-500 to-purple-500 hover:opacity-90 transition ${
  ...
  return (
    <>
      ...
      <div className="relative z-10 min-h-screen text-white p-4 md:p-20">
        ...
        {/* Mood Grid */}
        {/* <div className=" rounded-[25%] p-4 md:p-6 grid grid-cols-2 sm:grid-cols-4 gap-4 md:gap-6 mb-12">
          {Object.keys(moods).map((mood) => (
            <motion.button
              key={mood}
              whileHover={{ scale: 1.12 }}
